...
//		log.info("Starting program for building design specification KB...");
	...
	public Model runRule_inferFeatureType(Model kb){
		...
		Uni.of(FunQL::new)
		   ...
		   .set(q->q.addPlan("resources/META-INF/rules/specification/infer-feature-type-closedslot.q", this))
		   .set(q->q.addPlan("resources/META-INF/rules/specification/infer-feature-type-closedpocket.q", this))
